...
SELECT ROUND(30.45),ROUND(30.44) FROM DUAL; -- 30,30 소수점 첫째자리만 판단?
--ROUND(숫자, 자리수) : 자리수 이하 반올림 예) ROUND(95.789, 2) -> 95.79
SELECT ROUND(30.45, 1),ROUND(30.44,1) FROM DUAL; -- 30.5, 30.4 소수점 N자리까지 쓰겠다
SELECT ROUND(30.445, 2),ROUND(30.444,2) FROM DUAL;
--TRUNC(숫자) : 정수만 남기고, 소수부 버림
--TRUNC(숫자, 자리수) : 정수 이하 자리수까지 유지 
SELECT TRUNC(30.999), TRUNC (30.111) FROM DUAL; 
SELECT TRUNC(-30.999), TRUNC (-30.111) FROM DUAL;
